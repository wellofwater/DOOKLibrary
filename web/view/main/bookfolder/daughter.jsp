					...
					<div class="single-post row">
						<div class="col-lg-12">
							<div class="feature-img">
								<img class="img-fluid" src="view/main/img/bookimg/daughter.jpg" alt="" style="width:200px">
							</div>
						</div>
						...
						<div class="col-lg-9 col-md-9">
							<h3 class="mt-20 mb-20">딸은 엄마의 감정을 먹고 자란다 <br>:세상의 모든 딸, 엄마, 여자를 위한 자기 회복 심리학</h3>
							<p class="excert">
